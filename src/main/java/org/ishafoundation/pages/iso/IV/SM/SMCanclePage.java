...
public class SMCanclePage {
	private Page page;
	
	public SMCanclePage(Page page) {
		this.page =page;
	}
	
	private String cancletitle = "h2[class='title']";
	private String failetitle = "h2[class='title']";
	...
	public boolean isfailedPageOpen() {
		...
		try {
		    ...
		    if (page.url().contains("failed")) {
		        page.waitForSelector(failetitle, new Page.WaitForSelectorOptions().setTimeout(10000));
		        return page.isVisible(failetitle);
		    } else {
