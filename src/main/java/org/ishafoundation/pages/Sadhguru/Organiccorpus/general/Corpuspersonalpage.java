...
public class Corpuspersonalpage {
	
	private Page page;
	
	public Corpuspersonalpage(Page page) {
		this.page =page;
	...
	private String personhonoured ="#honouredPersons";
	   ...
	   public void EnterFirstname() {
	    	page.fill(Firstname, "sonam");
	    }
	    public void EnterLasttname() {
	    	page.fill(Lastname, "Bodake");
	    }
	    public void EnterEmail() {
	    	page.fill(Email, "ridhi@yopmail.com");
	    }
	  ...
	  /*  	// To select future date 
	    ...
	    //	calender.locator("//tabel//tbody//tr//td[not(contains(@class,' ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled '))]/a[text()='" + day + "']").click();
	    	...
	    	*/
			page.locator("//input[@id='dateOfOccasion']").click();
			page.locator("a.ui-state-default.ui-state-highlight:visible").click();
	    }
