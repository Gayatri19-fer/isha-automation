...
public class marriageOrganicPersonalDetailsPage {
	private Page page;
	
	public marriageOrganicPersonalDetailsPage(Page page) {
		this.page =page;
	}
	...
	private String personhonoured ="#honouredPersons";
	   ...
	   public void EnterFirstname() {
	    	page.fill(Firstname, "Nikita");
	    }
	    public void EnterLasttname() {
	    	page.fill(Lastname, "shinde");
	    }
	    public void EnterEmail() {
	    	page.fill(Email, "anuradha@yopmail.com");
	    }
	    public void EnterPhonenumber() {
	    	page.fill(Phonenumber, "8796821945");
	    }  
