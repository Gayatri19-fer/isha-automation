...
public class MSRGeneralDonationTest extends BaseTest{
	
	  @Test(groups= {"sanity"},retryAnalyzer = Retry.class)
	public void MSRGeneralDonationflow()  {
	page.navigate("https://mahashivarathri.org/en/online-contribution/general-donation/donate");
	...
	msrpersonal.Selectstate();
	msrpersonal.Enetercity();
