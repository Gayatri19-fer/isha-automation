...
public class Generalcorpusfund2PassTest extends BaseTest{
	
	@Test(groups= {"sanity","auth"}, retryAnalyzer = Retry.class)
	public void generalcorpusfund2passflow() {
		page.navigate(ConfigReader.get("sadhguru.url")+ "/en/contribute/isha-foundation-general-corpus-fund-2/donate");
	...
	//	OPM.FailInd();
		payment.payucancle();  // for prod but not working on prod
